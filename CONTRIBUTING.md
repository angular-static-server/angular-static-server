...
- **Version** - which version is affected
...
You can file new issues by providing the above information [here](https://github.com/angular-static-server/angular-static-server/issues/new/choose).

### <a name="submit-pr"></a> Submitting a Pull Request (PR)

- Search [GitHub](https://github.com/angular-static-server/angular-static-server/pulls) for an open or closed PR
...
- Test your changes with the Angular test projects.
- Run tests via `go test ./...` and ensure that all tests pass.
...
- In GitHub, send a pull request to `angular-static-server:master`.
...
[github]: https://github.com/angular-static-server/angular-static-server